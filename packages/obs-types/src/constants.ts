...
/** Custom attribute keys used by @obsunified/telemetry-sdk to carry large payloads
...
/** RFC 0004 — click-scoped correlation id. Stamped by @obsunified/telemetry-sdk's
