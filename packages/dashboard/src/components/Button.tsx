...
const VARIANT: Record<ButtonVariant, string> = {
	primary:
		"bg-sys-primary text-sys-on-primary font-semibold hover:bg-micro-gradient",
	ghost:
	...
	danger: "bg-sys-error text-sys-on-error font-semibold hover:opacity-90",
	warning: "bg-sys-warning text-sys-on-warning font-semibold hover:opacity-90",
	accent:
		"bg-sys-accent text-sys-on-accent font-semibold hover:bg-micro-gradient",
};
