...
See [INSTRUMENTATION_GUIDE.md](./INSTRUMENTATION_GUIDE.md) for the full
table. TL;DR: the SDK provides span/log/AI primitives and the OpenInference
conventions; your application wires call sites and choice of LLM-call
boundaries.

## Identity propagation

The interaction key flows browser → server through the
`x-obs-interaction` header. Call `stampInteractionFromRequest(span, req)`
once on the root span; child spans and logs inherit automatically. See
