 ...
 *
 * Like @obs-unified/brand's sync-to-projects, the docs / presence / skills repos
...
const tsModule = `// AUTO-GENERATED by @obs-unified/messaging sync — do not edit.
...
if (check && stale) {
	console.error(
		`\nmessaging:sync --check failed: ${stale} vendored copy(ies) stale. Run \`pnpm --filter @obs-unified/messaging sync\`.`,
	);
	process.exit(1);
}
console.log(
