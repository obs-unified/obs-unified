 ...
 * the @obsunified/dashboard build output. The Workers runtime handles static file
 * serving automatically; this plugin provides the fallback route for SPA
 * client-side routing.
 *
 * For Node.js / other runtimes: serve static files from @obsunified/dashboard/dist
